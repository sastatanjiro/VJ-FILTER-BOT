...
API_ID = int(environ.get('2129786446', ''))
API_HASH = environ.get('API_HASH', '')
BOT_TOKEN = environ.get('7246750492:AAErBJTka9LrH0FDPMot40FMYQwRmRZyUGs', "")
...
# Admins & Users
ADMINS = [int(2129786446) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()] # For Multiple Id Use One Space Between Each.
